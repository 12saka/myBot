...
export class MarketsController {
  ...
  async getTickers() {
    ...
    const meta: Record<string, { name: string, marketCap: number, type: string }> = {
      ...
      'BTC/USD': { name: 'Bitcoin',          marketCap: 1260000000000, type: 'crypto' },
      'ETH':     { name: 'Ethereum',         marketCap: 380000000000,  type: 'crypto' },
      'ETH/USD': { name: 'Ethereum',         marketCap: 380000000000,  type: 'crypto' },
      'SOL':     { name: 'Solana',           marketCap: 82000000000,   type: 'crypto' },
      'SOL/USD': { name: 'Solana',           marketCap: 82000000000,   type: 'crypto' },
      'BNB':     { name: 'Binance Coin',     marketCap: 64000000000,   type: 'crypto' },
      'BNB/USD': { name: 'Binance Coin',     marketCap: 64000000000,   type: 'crypto' },
      'XRP':     { name: 'Ripple',           marketCap: 35000000000,   type: 'crypto' },
      'XRP/USD': { name: 'Ripple',           marketCap: 35000000000,   type: 'crypto' },
      ...
      'XAU/USD': { name: 'Gold (XAU/USD)',   marketCap: 0, type: 'commodity' },
