...
const PRICING_PLANS = [
  {
    ...
    highlight: false,
    color: BRAND.amber,
    description: 'Explore TradeMind free for 14 days with full Academy and signal access.',
    features: [
      '10 Signals / week',
      'Basic Quantitative Strategy',
      'Full Living Academy Access',
  ...
  },
  {
    ...
    highlight: false,
    color: BRAND.cyan,
    description: 'Essential institutional signals & full Academy for growing traders.',
    features: [
      '10 Signals / week',
      'Basic Quantitative Strategy',
  ...
  },
  {
    ...
    highlight: true,
    color: BRAND.purple,
    description: '50 signals/week, Advanced SMC strategy & complete Academy.',
    features: [
      '50 Signals / week',
      'Advanced SMC Strategy Engine',
      'Full Academy & Advanced Quizzes',
      'Gold, Crypto & Forex Markets',
      'Advanced Indicators & Alerts',
      'Zoom Live Webinar Access',
      'PayHero Instant STK Push',
    ],
  },
  {
    name: 'Pro / Elite Plan',
    ...
    highlight: false,
    color: BRAND.green,
    description: 'Maximum 100 signals/week capacity, Full Strategy engine & Instructor Q&A.',
    features: [
      '100 Signals / week (Highest)',
      'Full Institutional Quantitative Engine',
      'Full Academy & Instructor Q&A',
      'ALL Market Assets + Stocks',
...
const JOURNEY_STEPS = [
  { step: '01', title: 'Sign Up & Verify',   desc: 'Create your account in 60 seconds. Complete KYC verification with automated document scanning.', icon: Users },
  ...
  { step: '03', title: 'Get Market Signals', desc: 'Real-time BUY/SELL signals generated by our quantitative strategy engine with full reasoning transparency.', icon: Zap },
  { step: '04', title: 'Execute & Automate', desc: 'Trade manually or enable autonomous execution. Set risk parameters and let the system work for you.', icon: Cpu },
  { step: '05', title: 'Track & Optimise',   desc: 'Monitor portfolio performance, review strategy analytics, and continuously improve your execution.', icon: BarChart3 },
];
...
const FAQS = [
  {
    q: 'How does TradeMind generate its trading signals?',
    a: 'Our quantitative multi-factor engine combines specialized analytical models trained on technical analysis, fundamental data, macroeconomic indicators, and market sentiment. Signals are generated by an ensemble confluence across all indicators, weighted by historical accuracy for each asset class.',
  },
  {
    q: 'Is my money safe on the platform?',
    a: 'TradeMind uses AES-256 encryption, SOC 2 Type II certified infrastructure, 2FA/biometric authentication, and segregated client wallets. We are regulated and compliant in all jurisdictions we operate. Insurance covers up to $500,000 per account.',
  },
  {
    q: 'Can I use TradeMind for automated trading without watching the markets?',
  ...
  {
    q: 'What markets and assets does TradeMind support?',
  ...
  {
    q: 'Do I need trading experience to use TradeMind?',
    a: 'No. The Academy section provides guided learning paths from beginner to advanced. The Copilot explains every signal and strategy in plain language. Most users are executing structured trades within their first session.',
  },
];

const FOOTER_LINKS = {
  Platform:  ['Dashboard', 'Markets', 'Signals', 'Portfolio', 'Wallet'],
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <motion.div style={{ opacity: heroOpacity, scale: heroScale }} className="space-y-8">
            ...
            >
              TradeMind combines quantitative intelligence, market analytics, risk management, and automated trading strategies
        ...
        <div className="mx-auto max-w-7xl px-6">
          <FadeIn className="text-center mb-16 space-y-4">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              ...
              TradeMind monitors global markets and institutional flows in real time.
            </p>
          </FadeIn>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/5 text-[10px] uppercase tracking-widest text-slate-600">
                      ...
                      <th className="text-right px-6 py-3 font-bold hidden md:table-cell">Signal</th>
                    </tr>
                  </thead>
                  <tbody>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <FadeIn delay={0.15}>
                <p className="text-slate-400 text-base leading-relaxed">
                  TradeMind employs the same security infrastructure used by tier-1 financial institutions.
                  Every layer of the platform is hardened, audited, and continuously monitored.
                </p>
              </FadeIn>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              ...
              <FadeIn delay={0.15}>
                <p className="text-slate-400 text-base leading-relaxed">
                  TradeMind isn't about gambling on market moves — it's about disciplined, model-driven
      ...
      <section className="py-28" style={{ background: 'rgba(0,0,0,0.2)' }}>
        <div className="mx-auto max-w-7xl px-6">
          <FadeIn className="text-center mb-16 space-y-4">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              The TradeMind experience is designed to take you from zero to confident trading with guided system assistance every step.
            </p>
          </FadeIn>
      ...
      <section id="pricing" className="py-28">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {PRICING_PLANS.map(({ name, price, period, badge, highlight, color, description, features }, i) => (
              <FadeIn key={name} delay={i * 0.1}>
                <div
                  className="relative rounded-3xl p-6 border flex flex-col h-full transition-all duration-300 hover:-translate-y-1"
                  style={{
                ...
                >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex items-end gap-1 mb-2">
                      <span className="font-black text-3xl text-white">{price}</span>
                      <span className="text-slate-500 text-xs mb-1">{period}</span>
                    </div>
                  ...
                  <ul className="space-y-2.5 flex-1 mb-6">
                    {features.map((f) => (
                      <li key={f} className="flex items-start gap-2 text-xs text-slate-300 font-mono">
                        <CheckCircle size={14} style={{ color, flexShrink: 0, marginTop: '2px' }} />
                        {f}
                      </li>
                    ))}
                  </ul>
                  ...
                  <Link
                    href="/register"
                    className="block w-full text-center py-3 rounded-xl text-xs font-bold transition-all duration-300 hover:scale-105"
                    style={highlight
          ...
          <FadeIn delay={0.4} className="text-center mt-10 text-xs font-mono text-slate-400">
            All new users start on a <strong className="text-amber-300">14-day free trial</strong> with <strong className="text-purple-300">10 weekly signals</strong> and full Academy access. Instant activation via <strong className="text-emerald-400">PayHero M-Pesa STK Push</strong>.
          </FadeIn>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
            ...
            <div className="lg:col-span-2 space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-base text-white">TradeMind</div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
                Enterprise-grade trading platform. Autonomous signals, institutional risk management, and portfolio intelligence for every trader.
              </p>
              <div className="flex items-center gap-3">
                {[
                  { icon: Twitter,  href: '#' },
          ...
          <div className="border-t border-white/6 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-slate-600 text-xs">
              © 2026 TradeMind Ltd. All rights reserved. Trading involves risk.
            </div>
