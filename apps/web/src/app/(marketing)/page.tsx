...
const PRICING_PLANS = [
  {
    ...
    highlight: false,
    color: BRAND.amber,
    description: 'Explore TradeMind AI free for 14 days with full Academy and signal access.',
    features: [
      '10 AI Signals / week',
  ...
  },
  {
    ...
    highlight: false,
    color: BRAND.green,
    description: 'Maximum 100 signals/week capacity, Full AI engine & Instructor Q&A.',
    features: [
      '100 AI Signals / week (Highest)',
      'Full Deep-Learning AI Engine',
