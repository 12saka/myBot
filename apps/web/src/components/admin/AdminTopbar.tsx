...
export function AdminTopbar({ onOpenMobile }: AdminTopbarProps) {
  ...
  return (
    <header className="h-16 border-b border-white/10 bg-slate-950/95 backdrop-blur-2xl px-4 md:px-6 flex items-center justify-between shrink-0 sticky top-0 z-40 shadow-xl shadow-black/50">
